...
specifying labels in quotes with arguments in the `labs()` function such as: `x = `, `y = `, 
...
minimum and maximum values, then you could also insert the argument `breaks = ` into the  the `scale_x_continuous()` function, followed by a vector of values
